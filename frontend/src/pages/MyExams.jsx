      ...
      {!assignments?.length ? (
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {assignments.map((assignment) => (
            <div key={assignment.id} className="group flex flex-col rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <h3 className="mb-6 text-lg font-bold text-slate-900 transition-colors group-hover:text-blue-600">{assignment.exam?.title}</h3>
